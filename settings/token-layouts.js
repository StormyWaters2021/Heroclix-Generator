export const TOKEN_LAYOUTS = {
  ...
  classic_blank: {
    ...
    stats: {
      speed: { x: -1000, y: -1000, iconX: -1000, iconY: -1000, iconWidth: 0, iconHeight: 0, fillMask: { image: "assets/masks/classic/speed.png", x: 302, y: 461 }, specialMarker: { x: 402, y: 522, width: 97, height: 97, stroke: "#000000", lineWidth: 7 } },
      attack: { x: -1000, y: -1000, iconX: -1000, iconY: -1000, iconWidth: 0, iconHeight: 0, fillMask: { image: "assets/masks/classic/attack.png", x: 342, y: 615 }, specialMarker: { x: 440, y: 688, width: 97, height: 97, stroke: "#000000", lineWidth: 7 } },
      defense: { x: -1000, y: -1000, iconX: -1000, iconY: -1000, iconWidth: 0, iconHeight: 0, fillMask: { image: "assets/masks/classic/defense.png", x: 382, y: 768 }, specialMarker: { x: 480, y: 838, width: 97, height: 97, stroke: "#000000", lineWidth: 7 } },
      damage: { x: -1000, y: -1000, iconX: -1000, iconY: -1000, iconWidth: 0, iconHeight: 0, fillMask: { image: "assets/masks/classic/damage.png", x: 423, y: 922 }, specialMarker: { x: 525, y: 993, width: 97, height: 97, stroke: "#000000", lineWidth: 7 } }
    },
    statText: {
      fontRole: "stats",
      maxWidth: 0,
    ...
    improvedAbilities: {
      movement: {
        slots: [
          { x: -1000, y: -1000, width: 0, height: 0, rotation: 0 },
          { x: -1000, y: -1000, width: 0, height: 0, rotation: 0 },
          { x: -1000, y: -1000, width: 0, height: 0, rotation: 0 },
          { x: -1000, y: -1000, width: 0, height: 0, rotation: 0 },
          { x: -1000, y: -1000, width: 0, height: 0, rotation: 0 },
